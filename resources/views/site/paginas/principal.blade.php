...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assests/site/css/photography.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('assests/site/css/photography-addons.css') }}" type="text/css" />


    <link rel="stylesheet" href="{{ asset('assests/site/css/font-icons.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('assests/site/css/one-page/et-line.css') }}" type="text/css" />
    ...
    <link rel="stylesheet" href="{{ asset('assests/site/css/fonts.css') }}" type="text/css" />

	<link rel="stylesheet" href="{{ asset('assests/site/css/fonts.css') }}" type="text/css" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />


    <link rel="stylesheet" href="{{ asset('assests/site/css/colors.php?color=c85e51') }}" type="text/css" />
...
<body class="stretched side-header side-header-right open-header">
    ...
    <script src="{{ asset('assests/site/js/photography-addons.js') }}"></script>
